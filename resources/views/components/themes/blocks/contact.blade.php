                    ...
                    <dl class="mt-8 text-base font-bold text-[#6F7490]">
                        <div
                            ...
                            <dd class="flex">
                                ...
                                <span class="ml-3">
                                    <a href="tel:+442071234567" target="_blank/" class="hover:text-gray-400">
                                        +1 (555) 123-4567
                                    </a>
                                </span>
                            </dd>
                        ...
                        <div
                            ...
                            <dd class="flex">
                                ...
                                <span class="ml-3">
                                    <a href="mailto:example@somewhere.com" target="_blank/" class="hover:text-gray-400">
                                        Jhondoe@gmail.com
                                    </a>
                                </span>
                            </dd>
                        ...
                        <div class="flex mt-10 space-x-4">
                            <span
                                data-aos="fade-right"
                                data-aos-delay="550">
                                <a href="#" target="_blank" class="opacity-75 hover:opacity-100 transition-opacity">
