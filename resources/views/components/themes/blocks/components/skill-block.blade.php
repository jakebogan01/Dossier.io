...
@if($user['skill'] !== "")
    <li class="{{ $class }}" data-aos="{{ $animateType }}" data-aos-delay="{{ $animateDelay }}">
        <div class="flex justify-center pb-4">
            <div class="sm:absolute top-0 sm:left-3/4 sm:-translate-x-1/2 sm:-translate-y-1/2 flex items-center justify-center w-[65px] h-[65px] rounded-full sm:transition-all" style="background-image: linear-gradient(to bottom right, #FFD279, #FFF659);">
