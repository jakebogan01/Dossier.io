<section {{ $attributes->merge(['class' => 'template_one_experiences relative bg-[#1C1F2D] px-[25px] sm:px-[5.3125rem] py-40 text-[#B1B7D6] text-base leading-loose overflow-hidden bg-no-repeat bg-bottom lg:bg-right-bottom bg-auto transition-all group']) }}>
    ...
    <div class="pb-12 sm:pb-8 lg:pb-0 lg:mb-8 ml-[10px] sm:ml-0 flex justify-between lg:flex-row-reverse items-center w-full left-timeline border-l-4 border-[#363A4D] lg:border-none transition-all">
        ...
        <div class="z-20 flex items-center order-1 shadow-xl w-8 h-8 rounded-full">
            <div class="-ml-[13px] lg:mx-auto -translate-y-[93px] sm:-translate-y-[28px] transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="69" viewBox="0 0 21 69"><g transform="translate(0 48)"><rect width="10" height="50" transform="translate(5 -48)" fill="#1c1f2d"/><circle cx="10.5" cy="10.5" r="10.5" fill="#ffcf7b"/><circle cx="4.5" cy="4.5" r="4.5" transform="translate(6 6)" fill="#1c1f2d"/></g></svg>
            </div>
        </div>
