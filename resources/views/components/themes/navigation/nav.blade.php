<nav class="mt-10 transition-all duration-300 delay-500 overflow-hidden" :class="{ 'w-[3.625rem]': menuStatus, 'w-0': !menuStatus }" x-cloak="menuStatus">
    <div class="relative flex flex-col items-center justify-center">
        <div class="fixed top-8 space-y-8 invisible" :class="{ 'visible': menuStatus, 'invisible': !menuStatus }">
            <a href="#home" class="block opacity-50 hover:opacity-100 transition-opacity" aria-current="page">
                <svg xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300" :class="{ 'translate-y-0 opacity-100 delay-700': menuStatus, 'translate-y-10 opacity-0 delay-300': !menuStatus }" width="35" height="35" viewBox="0 0 35 35"><path d="M17.5,0A17.5,17.5,0,1,0,35,17.5,17.5,17.5,0,0,0,17.5,0Zm0,8.065,8.545,6.641v12.23H20.166V19.553H14.834v7.383H8.955V14.706Z" fill="#fff"/></svg>
            </a>

            <a href="#skills" class="block opacity-50 hover:opacity-100 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300" :class="{ 'translate-y-0 opacity-100 delay-800': menuStatus, 'translate-y-10 opacity-0 delay-250': !menuStatus }" width="35" height="35" viewBox="0 0 35 35"><path d="M22.25,15.25h-3.5v-3.5h3.5m0,17.5h-3.5V18.75h3.5M20.5,3A17.5,17.5,0,1,0,38,20.5,17.5,17.5,0,0,0,20.5,3Z" transform="translate(-3 -3)" fill="#fff"/></svg>
            </a>

            <a href="#experience" class="block opacity-50 hover:opacity-100 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300" :class="{ 'translate-y-0 opacity-100 delay-900': menuStatus, 'translate-y-10 opacity-0 delay-200': !menuStatus }" width="35" height="35" viewBox="0 0 35 35"><path d="M18.512,29.673a11.258,11.258,0,0,1-7.937-3.247l7.937-7.84V7.5a11.087,11.087,0,1,1,0,22.173Z" transform="translate(-1.039 -1.087)" fill="#fff"/><path d="M36.5,19A17.5,17.5,0,1,1,19,1.5,17.5,17.5,0,0,1,36.5,19Zm-3.182,0A14.318,14.318,0,1,1,19,4.682,14.318,14.318,0,0,1,33.318,19Z" transform="translate(-1.5 -1.5)" fill="#fff" fill-rule="evenodd"/></svg>
            </a>

            <a href="#projects" class="block opacity-50 hover:opacity-100 transition-opacity">
