<nav
    ...
    :class="{ 'w-[3.625rem]': menuStatus, 'w-0': !menuStatus }"
    x-cloak="menuStatus">
    <div class="relative flex flex-col items-center justify-center">
        <div
            class="fixed top-8 space-y-8 invisible"
            :class="{ 'visible': menuStatus, 'invisible': !menuStatus }">
            <a
                href="#home"
            ...
            <span
                class="block opacity-50 hover:opacity-100 transition-opacity cursor-pointer"
