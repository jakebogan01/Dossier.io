<div class="template_one flex font-lato" x-data="{ menuStatus: false, showBar: false }">
    ...
    <a href="#home" aria-label="back to top" class="fixed bottom-0 right-0 opacity-0 -translate-y-10 -translate-x-2 transition-all z-50" :class="{ 'opacity-100' : showBar }" @scroll.window="showBar = (window.pageYOffset >= 20)">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-16 h-16 opacity-50 hover:opacity-100 transition-opacity" viewBox="0 0 20 20" fill="#ffffff">
