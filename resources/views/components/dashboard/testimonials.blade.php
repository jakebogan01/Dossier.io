                                    ...
                                    <div class="mt-6 flex flex-col lg:flex-row">
                                        <div class="flex-grow space-y-28">
                                            <template x-for="(field, index) in fields" :key="field.id">
                                                <div>
                                                    <div class="flex justify-end">
                                                        <button type="button" class="border border-transparent text-indigo-300 sm:hover:text-indigo-600 focus:outline-none transition-colors" @click="removeField(field)">
                                                    ...
                                                    <div class="grid grid-cols-4 gap-6 mt-5">
                                                        <div class="relative col-span-4 sm:col-span-2 border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                                                            <label for="company-website" class="absolute -top-2 left-2 -mt-px inline-block px-1 bg-white text-xs font-medium text-gray-900">Project</label>
        ...
        return {
            ...
            addNewField() {
                if (this.fields.length >= 6) {
                    return alert('Only 6 can be created.');
                }
