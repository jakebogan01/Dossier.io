...
<li class="py-4 flex items-center justify-between">
    ...
    <div class="relative inline-block h-6 w-11 align-middle select-none sm:transition duration-200 ease-in">
        ...
        <label for="{{ $setting }}" class="{{ (auth()->user()->dark_mode) ? 'toggle-dark-label bg-[#262c33]' : 'toggle-label bg-gray-200' }} block overflow-hidden h-6 w-11 rounded-full cursor-pointer sm:transition"></label>
