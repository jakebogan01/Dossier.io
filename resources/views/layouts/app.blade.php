                                ...
                                <div class="nav_container bg-[#48128A] w-full max-w-[256px] h-full flex flex-col py-6 overflow-y-auto shadow-xl transform transition-all duration-300 ease-linear">
                                    ...
                                    <nav
                                        ...
                                        <a
                                            ...
                                            class="sm:hover:text-white group flex pb-4 text-sm font-bold transition-colors {{ (request()->routeIs('dashboard')) ? 'text-white' : 'text-white sm:text-[#9650d9]' }}">
                                        ...
                                        <a
                                            href="{{ route('profile') }}"
                                            class="sm:hover:text-white group flex py-4 text-sm font-bold transition-colors {{ (request()->routeIs('profile')) ? 'text-white' : 'text-white sm:text-[#9650d9]' }}">
                                            <span class="relative flex items-center pl-10 grow">
