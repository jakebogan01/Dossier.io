                        ...
                        <div class="mt-8">
                            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                                    <div class="bg-white overflow-hidden shadow-md sm:hover:shadow-sm  rounded-lg transition-all duration-300 ease-linear">
                                        <div class="p-5">
                                        ...
                                        <div class="bg-gray-50 px-5 py-3">
                                            <div class="text-sm">
                                                <a
                                                    href="#"
                                                    class="font-medium text-cyan-700 sm:hover:text-cyan-900">
                                                    View all
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <h2 class="mx-auto mt-8 px-4 text-lg leading-6 font-medium text-gray-900 sm:px-6 lg:px-8">
                                Recent activity
                            </h2>
                            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="flex flex-col mt-2">
                                    <div class="align-middle min-w-full overflow-x-auto overflow-hidden sm:rounded-lg shadow-md sm:hover:shadow-sm transition-all duration-300 ease-linear">
                                        <table class="min-w-full divide-y divide-gray-300">
                                            ...
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                    <a
                                                        href="#"
                                                        class="text-indigo-600 sm:hover:text-indigo-900">
