        ...
        <div class="grid grid-cols-1 gap-6 mt-5">
            ...
            <div>
                <div class="relative col-span-1  border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                    ...
                    <input wire:model="updateJobPosition" type="text" name="updateJobPosition" id="updateJobPosition" class="block w-full border-0 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" required>
                </div>
        ...
        <div class="grid grid-cols-4 gap-6 mt-5">
            <div class="relative col-span-4 sm:col-span-2 border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input wire:model="updateFacebook" type="text" name="updateFacebook" id="updateFacebook" class="block w-full border-0 pl-16 sm:pl-[48px] py-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" required>
                </div>
            ...
            <div class="relative col-span-4 sm:col-span-2 border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-indigo-600 focus-within:border-indigo-600">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input wire:model="updateLinkedin" type="text" name="updateLinkedin" id="updateLinkedin" class="block w-full border-0 pl-16 sm:pl-[48px] py-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" required>
                </div>
