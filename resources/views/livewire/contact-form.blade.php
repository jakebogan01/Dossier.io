<form action="#" x-data="{ notify: @entangle($toggleWarning) }">
    ...
    <section class="grid grid-cols-1 gap-10 md:grid-cols-2 2xl:grid-cols-3 mt-8" x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'conclusion' }" id="tab_wrapper">
