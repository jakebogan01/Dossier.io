<div class="flex text-[#39499E] space-x-4 transition-colors" x-data="{ showSmallMenu: false, switchToDarkMode: false }" @click.away="showSmallMenu = false" @close.stop="showSmallMenu = false">
    <div class="flex justify-center items-center">
        <button type="button" class="text-gray-500 group rounded-full inline-flex items-center text-[#39499E] focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-transparent" style="box-shadow: none;" aria-expanded="false" @click="switchToDarkMode = !switchToDarkMode">
    ...
    <div class="flex justify-center items-center">
        <div class="relative pt-2">
            ...
            <button type="button" class="text-gray-500 group rounded-full inline-flex items-center text-[#39499E] focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-transparent" style="box-shadow: none;" aria-expanded="false" @click="showSmallMenu = !showSmallMenu">
