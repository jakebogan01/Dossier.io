<div x-data="{ settingMenu: false }" @click.away="settingMenu = false" @close.stop="settingMenu = false" class="flex items-center text-[#39499E] space-x-4 transition-colors">
    <livewire:dark-mode />
    <div class="relative">
        <button type="button" class="group rounded-full text-white sm:text-[#39499E] focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-transparent" style="box-shadow: none;" aria-expanded="false" @click="settingMenu = !settingMenu">
    ...
    <a href="{{ route('theme-one', auth()->user()->profile->slug ) }}" target="_blank" class="flex">
        <button type="button" class="{{ (auth()->user()->dark_mode) ? 'text-white' : 'text-white sm:text-[#39499E]' }} group rounded-full inline-flex items-center text-base font-medium outline-none border-none sm:hover:outline-none sm:hover:ring-0 sm:hover:ring-transparent" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:hover:text-white cursor-pointer transition-colors" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd" /></svg>
        </button>
    </a>
</div>
