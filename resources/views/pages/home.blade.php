<x-layouts.main>
    ...
    <div class="relative h-full max-w-[1920px] mx-auto bg-[#1C1F2D]">
        <div class="absolute h-full w-full top-0 left-0 bg-no-repeat bg-center bg-cover"
             style="background-image: url('/images/home/png/tree-background@2x.png');">

            <div class="flex h-full w-full bg-no-repeat bg-right bg-cover"
                 style="background-image: url('/images/home/svg/home-background-d.svg');">
