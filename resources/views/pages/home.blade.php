<x-layouts.main>
    ...
    <div class="home" style="background-image: linear-gradient(to bottom right, #0F0B21, #3C4DA6)">
                        ...
                        <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                            <div
                                ...
                                <div class="absolute flex justify-center items-center inset-0 h-full w-full bg-purple-500">
                                    <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_dkuwscrg.json"  background="transparent"  speed="1"  style="width: 500px; height: 500px;"  loop  autoplay></lottie-player>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-[#0F1119]">
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                ...
                <ul role="list" class="mx-auto grid grid-cols-2 gap-x-4 gap-y-8 md:gap-x-6 lg:max-w-4xl lg:gap-x-2 sm:grid-cols-4 mt-10">
                    <li
                        data-aos="fade-up"
                        data-aos-delay="100">
                        <div class="space-y-4 text-center">
                            <img class="mx-auto h-16 w-16 rounded-full border-4 border-indigo-500" src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="" loading="eager">
                            <div class="space-y-2">
